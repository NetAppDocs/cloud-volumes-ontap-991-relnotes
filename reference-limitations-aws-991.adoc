---
sidebar: sidebar
permalink: reference-limitations-aws-991.html
...
= Known limitations for Cloud Volumes ONTAP 9.9.1 in AWS
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
The following known limitations are specific to Cloud Volumes ONTAP in Amazon Web Services. Be sure to also review link:reference-limitations-991.html[Limitations for Cloud Volumes ONTAP 9.9.1 in all cloud providers].
